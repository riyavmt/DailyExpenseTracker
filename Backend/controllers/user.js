...
exports.forgotPassword = async (req,res) =>{
    ...
    sendSmtpEmail = {
        ...
        HTMLContent: `<html><head></head><body><a  href="http://13.51.175.59/reset-password/${uuid}">Click to reset your password</a>`
    };
    try {
  ...
  exports.resetPassword = async(req,res)=>{
    ...
    try{
        ...
        if(result&&result.isActive){
            ...
            const htmlContent = `<html><head></head><body><h1>This Link has already been used.</h1><a href="http://13.51.175.59/forgotPassword.html">Click here to reset password</body></html>`;
